# -*- coding: utf-8 -*-
"""
Alpha Radar v1.2  (FMZ 单文件策略)
================================================================
研究型价格结构观测系统。无任何实盘发单逻辑。
蓝图: alpha_radar_spec v1.2 / 参考: gamma_spatial_observer_v6.py
...
class Display:
    ...
    def _update_status(self, raw_row, labels, system_state,
        ...
        summary = (
            "Alpha Radar v1.2 | 价={} | 偏差={}σ | {} | 分类={} ({})".format(
                fmt_price(price),
                fmt_number(nd, 2),
                event_state,
...
def run():
    ...
    log_info("Alpha Radar v1.2 启动。K={}, volume_bar_n={} BTC".format(
